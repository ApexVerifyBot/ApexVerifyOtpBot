...
WELCOME_MESSAGE = """⚡ APEX 𝗦𝗠𝗦 𝗣𝗔𝗡𝗘𝗟 𝗕𝗢𝗧 ⚡ 
━━━━━━━━━━━━━━━━━━━━━━
...
SUPPORT_LINK = "https://t.me/ApexVerifysupport"      # সাপোর্ট লিংক পরিবর্তনযোগ্য
...
def get_admin_panel_text():
    ...
    text = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "💎 <i>Apex SMS Bot • Live & Operating</i>"
    )
    return text
                ...
                for otp in otps:
                    ...
                    if (matched_key is not None and
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ PANEL", url="https://t.me/ApexVerify_Bot", style="primary"),
...
async def fast_allocate_number_multi(query, context, ranges_list, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/+w_3QvV-NqM8wOGI9", style="primary")]
    ])
    try:
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "SUPPORT" in text:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("💬 SUPPORT", url=https://t.me/ApexVerifysupport, style="primary")],
